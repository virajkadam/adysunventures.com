      ...
      <div className="section-clients bg-light py-5">
        <div className="container">
          <div className="owl-carousel owl-theme clients" id="clients">
            {/* Create common style and event handlers */}
            {(() => {
              // Common style object for all logo images
              const logoStyle = {
                maxHeight: "70px", 
                maxWidth: "120px", 
                objectFit: "contain",
              ...
              // List of all logo file names
              const logos = [
                { name: "android", file: "android.png" },
                { name: "angularjs", file: "angularjs.png" },
                { name: "aws", file: "aws.png" },
                { name: "azure", file: "azure.png" },
                { name: "bigdata", file: "bigdata.png" },
                { name: "blockchain", file: "blockchain.png" },
                { name: "cpp", file: "c++.png" },
                { name: "chash", file: "chash.png" },
                { name: "coeigniter", file: "coeigniter.png" },
                { name: "drupal", file: "drupal.png" },
                { name: "electronjs", file: "electronjs.png" },
                { name: "firebase", file: "firebase.png" },
                { name: "flutter", file: "flutter.png" },
                { name: "googlecloud", file: "googlecloud.png" },
                { name: "hadoop", file: "hadoop.png" },
                { name: "hybrid-app", file: "hybrid-app.png" },
                { name: "icloud", file: "icloud.png" },
                { name: "ionic", file: "ionic.png" },
                { name: "ios", file: "IOS.png" },
                { name: "java", file: "java.png" },
                { name: "javascript", file: "javascript.png" },
                { name: "joomla", file: "joomla.png" },
                { name: "laravel", file: "laravel.png" },
                { name: "machinelearning", file: "machinelearning.png" },
                { name: "magento", file: "magento.png" },
                { name: "native-app", file: "native-app.png" },
                { name: "nodejs", file: "nodejs.png" },
                { name: "objective-c", file: "objective-c.png" },
                { name: "opencart", file: "opencart.png" },
                { name: "phone-gap", file: "phone-gap.png" },
                { name: "php", file: "php.png" },
                { name: "powerbi", file: "powerbi.png" },
                { name: "pwa", file: "pwa.png" },
                { name: "python", file: "python.png" },
                { name: "react-native", file: "react-native.png" },
                { name: "reactjs", file: "reactjs.png" },
                { name: "ruby", file: "ruby.png" },
                { name: "spagobi", file: "spagobi.png" },
                { name: "swift", file: "swift.png" },
                { name: "symfony", file: "symfony.png" },
                { name: "tensorflow", file: "tensorflow.png" },
                { name: "vuejs", file: "vuejs.png" },
                { name: "wordpress", file: "wordpress.png" },
                { name: "wpf", file: "wpf.png" },
                { name: "xamarin", file: "xamarin.png" }
              ];
              
              // Return the array of logo elements
              return logos.map(logo => (
                <div key={logo.name} className="item d-flex justify-content-center align-items-center" style={{ height: "100px" }}>
                  <img
                    alt={logo.name}
                    src={require(`../../assets/images/brand-logos/${logo.file}`)}
                    style={logoStyle}
